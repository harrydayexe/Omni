...
\subsection{Parsing Markdown from External Sources}
...
However, embedding this raw HTML into a template and sending it back to the user is potentially dangerous.
