// The following is a modified version of the original pattern.go
// file from the Go standard library.
...
// The following code is taken from the httpguts package
// in the Go standard library. All rights belong to the
// original author.
